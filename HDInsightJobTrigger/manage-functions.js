...
var ServiceAppActions = ( /** @lends ServiceAppActions */ function() {
  ...
  function init(callback) {
    ...
    msRestAzure.loginWithServicePrincipalSecret(config.clientId, config.secret, config.domain, function (err, credentials) {
      ...
      var appServiceClient = new ServiceAppActionsClient(this.credentials, this.baseUri, config);
...
var ServiceAppActionsClient = ( /** @lends HDInsightManagementClient */ function() {
  ...
  function ServiceAppActionsClient(credentials, baseUri, filters) {
  ...
  ServiceAppActionsClient.prototype.getActionRequestObject = function(websiteName, actionName, callback) {
    ...
    url2 = url2 + encodeURIComponent(config.resourceGroupName);
    url2 = url2 + '/providers/';
  ...
  ServiceAppActionsClient.prototype.get = function(websiteName, callback) {
    var _websiteName = typeof websiteName === 'string' && websiteName || config.functionAppName;
